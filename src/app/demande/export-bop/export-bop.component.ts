...
@Component({
  selector: 'app-export-bop',
  templateUrl: './export-bop.component.html',
  styleUrls: ['./export-bop.component.css']
})
export class ExportBopComponent implements OnInit {
  ...
  public insertionTiers = new FormGroup({
    ...
    NBop : new FormControl('' , Validators.required),
  ...
  valider () {
    ...
    this.loading = true;
    this.DonnerJson = {
      NBop : this.insertionTiers.get('NBop')?.value,
...
get NBop () {
  return this.insertionTiers.get('NBop');
}
get remarque () {
