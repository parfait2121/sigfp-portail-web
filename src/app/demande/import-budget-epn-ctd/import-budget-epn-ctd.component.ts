...
@Component({
  selector: 'app-import-budget-epn-ctd',
  templateUrl: './import-budget-epn-ctd.component.html',
  styleUrls: ['./import-budget-epn-ctd.component.css']

})
export class ImportBudgetEpnCtdComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.categorie =
    [{
      categorieName: "Import budget EPN",
      TypeCode: "SOA",
    },{
      categorieName: "Import budget CTD",
      TypeCode: "ORDSEC",
    },
  ...
  valider () {
    ...
    this.DonnerJson = {
      ...
      exercice : this.insertionTiers.get('exercice')?.value,
...
get exercice () {
  return this.insertionTiers.get('exercice');
}
get nom () {
