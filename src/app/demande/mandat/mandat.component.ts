...
export class MandatComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.categorie =
    [{
      categorieName: "Modification Objet",
      Abrv : "MO"
    },{
      categorieName: "Mise a jours etat rejet",
      Abrv : "MR"
  ...
  valider () {
    ...
    this.DonnerJson = {
      ...
      objet : this.insertionTiers.get('objet')?.value,
    ...
    var errorFile = 0;
      ...
      if(this.categorieProprety.Abrv === "MR") {
        ...
        // eto midy
          ...
          this.notif = "Veuillez attachez la piece jointe";
          this.loading = false;
        }
      }else {
        this.demandeService.insererDemande(this.demandeData ).subscribe(
...
get objet () {
  return this.insertionTiers.get('objet');
}
get nom () {
