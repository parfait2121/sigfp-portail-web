...
@Component({
  selector: 'app-import-marche',
  templateUrl: './import-marche.component.html',
  styleUrls: ['./import-marche.component.css']
})
export class ImportMarcheComponent implements OnInit {
  ...
  public insertionTiers = new FormGroup({
    ...
    RefMarche : new FormControl('' , Validators.required),
  ...
  valider () {
    ...
    this.loading = true;
    this.DonnerJson = {
      RefMarche : this.insertionTiers.get('RefMarche')?.value,
...
get RefMarche () {
  return this.insertionTiers.get('RefMarche');
}
get remarque () {
